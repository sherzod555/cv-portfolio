                ...
                <div>
                    ...
                    <div className=" py-5 flex flex-col md:flex-row md:gap-x-16 justify-center items-center font-mono">
                        ...
                        <div className="items-center flex flex-col md:items-start gap-y-5">
                            ...
                            <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold pt-3">Sherzod Yodgorov</h1>
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold">Front-end React JS Web developer</h3>
