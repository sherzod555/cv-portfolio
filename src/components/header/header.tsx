                ...
                <main className="container mx-auto w-[1300px]">
                    ...
                    <div className="flex items-center justify-between py-5 text-lg font-semibold">
                        ...
                        <div className="flex items-center gap-x-8">
                            ...
                            <div>
                                <img className="h-7 w-auto cursor-pointer" src={Uzb} alt="uzb"/>
                                <img className="h-7 w-auto cursor-pointer" src={Rus} alt="rus"/>
                                <img className="h-7 w-auto cursor-pointer" src={Eng} alt="eng"/>
                            </div>
